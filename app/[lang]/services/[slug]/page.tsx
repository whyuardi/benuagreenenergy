...
const content: Record<string, any> = {
  id: {
    'warranty-replacement': { title: 'Warranty Replacement', desc: 'Layanan penggantian garansi resmi untuk semua produk dan sistem PT. Benua Green Energy. Proses cepat, produk original, tenang tanpa biaya tambahan selama masa garansi.', benefits: ['Proses klaim cepat dan mudah', 'Produk original 100%', 'Garansi 1-5 tahun sesuai produk', 'Service nasional coverage'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    'energy-audit': { title: 'Energy Audit', desc: 'Audit energi komprehensif untuk mengidentifikasi inefisiensi sistem HVAC Anda. Kami memberikan rekomendasi solusi spesifik yang bisa menghemat biaya operasional hingga 40%.', benefits: ['Audit awal gratis tanpa komitmen', 'Laporan detail dengan data real-time', 'Rekomendasi solusi spesifik', 'ROI analysis & payback projection'], img: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=800' },
    'commissioning': { title: 'Commissioning', desc: 'Pengujian dan verifikasi sistem baru secara menyeluruh sesuai standar operasional internasional. Memastikan kinerja optimal sejak hari pertama operasi.', benefits: ['Verifikasi standar ISO', 'Dokumentasi teknis lengkap', 'Pelatihan operator terjadwal', 'Sertifikasi kelayakan operasi'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    'cleaning-optimization': { title: 'Cleaning & Optimization', desc: 'Layanan pembersihan dan optimasi sistem HVAC & Chiller secara berkala. Meningkatkan efisiensi, memperpanjang umur pakai, dan menurunkan konsumsi energi.', benefits: ['Chemical pembersih profesional', 'Optimasi set point sistem', 'Hemat energi 15-25%', 'Jadwal perawatan fleksibel'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    'diagnostics': { title: 'Diagnostics', desc: 'Diagnostik lanjutan menggunakan peralatan modern untuk deteksi dini potensi masalah sebelum menyebabkan kerusakan dan downtime yang mahal.', benefits: ['Thermal imaging & infrared scan', 'Vibration analysis', 'Oil & refrigerant analysis', 'Predictive maintenance report'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    'repair-maintenance': { title: 'Repair & Maintenance', desc: 'Perbaikan dan pemeliharaan rutin 24/7 oleh teknisi bersertifikasi. Coverage nasional dengan respon cepat dan spare part original.', benefits: ['Layanan darurat 24/7', 'Teknisi tersertifikasi', 'Spare part original', 'Kontrak preventive tersedia'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    'installation': { title: 'Installation', desc: 'Jasa instalasi profesional untuk HVAC, Chiller, Cooling Tower, dan Panel Surya oleh tim engineer berpengalaman dengan standar kualitas tertinggi.', benefits: ['Site survey & feasibility study', 'Instalasi standar pabrikan', 'Integrasi dengan sistem existing', 'Handover & training untuk operator'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
  },
  en: {
    'warranty-replacement': { title: 'Warranty Replacement', desc: 'Official warranty replacement service for all registered products and systems. Fast claim process, 100% original products, worry-free.', benefits: ['Fast & easy claim process', '100% original products', '1-5 year warranty coverage', 'Nationwide service'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    'energy-audit': { title: 'Energy Audit', desc: 'Comprehensive energy audit to identify HVAC system inefficiencies. We provide specific solution recommendations that can save up to 40% in operational costs.', benefits: ['Free initial audit', 'Real-time data report', 'Specific solution roadmaps', 'ROI & payback analysis'], img: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=800' },
    'commissioning': { title: 'Commissioning', desc: 'Thorough testing and verification of new systems according to international operational standards. Ensuring optimal performance from day one.', benefits: ['ISO standard verification', 'Full technical documentation', 'Scheduled operator training', 'Operational certification'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    ...
    'diagnostics': { title: 'Diagnostics', desc: 'Advanced diagnostics using modern equipment for early detection of potential problems before they cause costly downtime.', benefits: ['Thermal imaging & IR scan', 'Vibration analysis', 'Oil & refrigerant analysis', 'Predictive maintenance report'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    'repair-maintenance': { title: 'Repair & Maintenance', desc: '24/7 repair and maintenance by certified technicians with nationwide coverage. Fast response and original spare parts.', benefits: ['24/7 emergency service', 'Certified technicians', 'Original spare parts', 'Preventive contracts available'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
    'installation': { title: 'Installation', desc: 'Professional installation for HVAC, Chiller, Cooling Tower, and Solar Panels by experienced engineers with highest quality standards.', benefits: ['Site survey & feasibility', 'Manufacturer standards', 'System integration', 'Operator handover & training'], img: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800' },
  }
}
    ...
    <div className="page-enter">
      ...
      <section className="relative min-h-[50vh] flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 opacity-15 hero-zoom" style={{ backgroundImage: `url(${data.img})`, backgroundSize: 'cover', backgroundPosition: 'center' }} />
