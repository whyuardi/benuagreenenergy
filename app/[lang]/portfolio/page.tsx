  ...
  return (
    <div>
      {/* ═══════════════════════════════════════
          ...
          ═══════════════════════════════════════ */}
      <section className="section-dark relative min-h-[50vh] flex items-center overflow-hidden">
        <div className="green-glow top-[-150px] right-[15%] opacity-40" />
        <div className="green-glow bottom-[-200px] left-[10%] opacity-30" />
